...
from clautify.types import LoggerProtocol
...
class Logger(LoggerProtocol):
    ...
    def error(s: str, **extra: Any) -> None:
        with LOCK:
            fields = [
                f"{Style.BRIGHT}{Fore.LIGHTBLUE_EX}{k}={Fore.LIGHTRED_EX}{v}{Style.RESET_ALL}" for k, v in extra.items()
            ]
            print(f"{Logger.__fmt_time()} {Style.BRIGHT}{Style.RESET_ALL}{Fore.LIGHTRED_EX}{s} " + " ".join(fields))
    ...
    def attempt(s: str, **extra: Any) -> None:
        with LOCK:
            ...
            print(f"{Logger.__fmt_time()} {Style.BRIGHT}{Style.RESET_ALL}{Fore.LIGHTYELLOW_EX}{s} " + " ".join(fields))
    ...
    def info(s: str, **extra: Any) -> None:
        with LOCK:
            ...
            print(f"{Logger.__fmt_time()} {Style.BRIGHT}{Style.RESET_ALL}{Fore.LIGHTMAGENTA_EX}{s} " + " ".join(fields))
